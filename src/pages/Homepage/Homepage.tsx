...
const Homepage = () => {
  ...
  return (
    <>
      <Containers
        type="section-large"
        className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-8 rounded-xl lg:gap-y-16 xl:gap-y-0 gap-x-16 relative"
      >
      ...
      <Containers
        type="section-large"
        className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-4 rounded-xl lg:gap-y-16 xl:gap-y-0 gap-x-16 "
      >
        <figure className="rounded-xl p-4 row-span-2 row-start-2 col-start-2">
          <motion.img
        ...
        <article className={`lg:col-start-1 row-span-2 ${styleRow}`}>
          <ScrollHeading
            level="h2"
            className="md:w-[400px]"
            title="My projects"
